    ...
    return (
      ...
      <ImageBackground source={require('../assets/wallpaper.jpg')} style={{width: "100%", height: "100%"}}>
        ...
        <View style={stylesHome.buttonContainer}>
            ...
            <TouchableOpacity  style={stylesHome.buttonStyle} onPress={() => this.props.navigation.navigate("ProfileScreen")}>
              <Text style={stylesHome.textStyle}> Tillfällig knapp för profil </Text>
            </TouchableOpacity> 
          </View>
